...
top_k = 10 # initialised top_k here and added it to the fc_layer in line 100.
...
class ResNet18_32x32(nn.Module):
    def __init__(self, block=BasicBlock, num_blocks=None, num_classes=10):
        ...
        self.fc = nn.Linear(512 * block.expansion, num_classes*top_k)
...
CraftResNet18_32x32 = ResNet18_32x32
